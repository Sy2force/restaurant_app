...
const localizedValues = {
  he: {
    ...
    'Une plongée fascinante dans les ruelles de la vieille ville, à la découverte des saveurs millénaires qui font vibrer Jérusalem.': 'צלילה מרתקת לסמטאות העיר העתיקה, בעקבות טעמים עתיקים שמחיים את ירושלים.',
    'Tel Aviv Modern': 'תל אביב מודרנית',
    'La nouvelle cuisine israélienne': 'המטבח הישראלי החדש',
    'Explorez la scène culinaire vibrante de Tel Aviv, où tradition et innovation se rencontrent pour créer des plats uniques.': 'גלו את הסצנה הקולינרית התוססת של תל אביב, שבה מסורת וחדשנות נפגשות ליצירת מנות ייחודיות.',
    'Pâtisseries du Shuk': 'מאפי השוק',
    'Douceurs et desserts': 'מתוקים וקינוחים',
    "Les meilleures recettes de pâtisseries inspirées des marchés d'Israël. Babka, Rugelach et autres délices sucrés.": 'מתכוני המאפים הטובים ביותר בהשראת שווקי ישראל: בבקה, רוגלך ועוד פינוקים מתוקים.',
    'Vegan Israeli Kitchen': 'מטבח ישראלי טבעוני',
    'Plats végétaux gourmands': 'מנות צמחיות עשירות',
    "Découvrez comment la cuisine israélienne se prête merveilleusement bien à l'alimentation végétale, sans compromis sur le goût.": 'גלו איך המטבח הישראלי מתאים באופן נפלא לתזונה צמחית, בלי להתפשר על הטעם.',
  ...
  en: {
    ...
    'Cuisine française authentique au cœur de Tel Aviv.': 'Authentic French cuisine in the heart of Tel Aviv.',
