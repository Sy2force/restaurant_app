  ...
  return (
    <div className="min-h-screen bg-cream-50 dark:bg-dark-900 pb-24 md:pb-0">
      ...
      <div className="relative h-[50vh] md:h-[60vh] w-full overflow-hidden">
        <img
          src={getSafeImage(restaurant.coverImage || restaurant.imageUrl, 'cover')}
          alt={
            restaurant.coverImageAlt ||
            restaurant.imageAlt ||
            localizeValue(restaurant.name, i18n.language)
          }
          onError={imageOnError('cover')}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-16 text-white max-w-7xl mx-auto w-full">
          ...
          >
            <div className="relative">
              <img
                src={getSafeImage(restaurant.logo || restaurant.imageUrl, 'restaurant')}
        ...
        <div className="lg:col-span-1">
          ...
          >
            ...
            <div className="space-y-3 mb-6">
              ...
              {restaurant.reservationAvailable !== false && (
                <button
                  type="button"
